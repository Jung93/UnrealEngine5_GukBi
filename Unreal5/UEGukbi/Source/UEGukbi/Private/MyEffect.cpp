...
AMyEffect::AMyEffect()
{
	...
	static ConstructorHelpers::FObjectFinder<UNiagaraSystem> test(TEXT("/Script/Niagara.NiagaraSystem'/Game/Graphics/Effects/Vefects/Free_Fire/Shared/Particles/NS_Fire_Big.NS_Fire_Big'"));
